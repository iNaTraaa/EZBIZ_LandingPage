export default {
  ...
  hero: {
    ...
    brandTitle: 'EZBIZ',
    subTitle: 'Solution For Retail Businesses & Household Merchants',
    desc: 'Optimize sales, inventory management & instant financial reporting – Simple, easy to use, highly effective.',
    experienceOn: 'Experience now on',
    featureHeading: 'EZBIZ Key Features',
    feature1: 'POS Sales',
    feature2: 'Inventory Control',
    feature3: 'Revenue Analytics',
    feature4: 'AI Tax Assistance',
    btnPrimary: 'Start Free Trial ➔',
    btnSecondary: 'See How It Works',
    formTitle: 'Request Business Consultation',
    formBadge: '100% Free',
    companyLabel: 'Company / Store Name',
    companyPlaceholder: 'Enter your business name...',
    nameLabel: 'Representative Full Name',
    namePlaceholder: 'Enter full name...',
    phoneLabel: 'Contact Phone Number',
    phonePlaceholder: 'Enter phone number...',
    btnSubmit: 'Get Free Demo',
